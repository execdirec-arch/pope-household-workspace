/* Icons as inline SVG — Lucide-style stroke, 16×16 */
const Icon = ({ name, size = 16 }) => {
  const paths = {
    today: <><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></>,
    horizon: <><path d="M3 18h18"/><path d="M3 12l4-4 4 4 5-5 5 5"/></>,
    rapid: <><path d="M13 2L3 14h7l-1 8 10-12h-7z"/></>,
    fund: <><path d="M12 1v22"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></>,
    wips: <><path d="M3 3h7v7H3z"/><path d="M14 3h7v7h-7z"/><path d="M3 14h7v7H3z"/><path d="M14 14h7v7h-7z"/></>,
    inbox: <><path d="M22 12h-6l-2 3h-4l-2-3H2"/><path d="M5.45 5.11L2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"/></>,
    vault: <><path d="M3 3h18v18H3z"/><path d="M3 9h18"/><path d="M9 21V9"/></>,
