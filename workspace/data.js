...
window.WORKSPACE_DATA = {
  ...
  bills: [
    { id: "b1",  name: "Mortgage",       amount: 2975.82, dueDay: 17,   autopay: false, status: "active", servicer: "NewRez/ShellPoint", method: "Neighbors FCU", note: "Manual — floats 14-17" },
    ...
    { id: "b4",  name: "AT&T",           amount: 114.99,  dueDay: 27,   autopay: true,  status: "active", servicer: "AT&T",              method: "autopay", note: "Cell — replaced T-Mobile" },
    { id: "b5",  name: "RMA Music",      amount: 344.62,  dueDay: 16,   autopay: true,  status: "active", servicer: "RMA Music School",  method: "PayPal" },
    { id: "b6",  name: "Life Ins",       amount: 113.36,  dueDay: 14,   autopay: true,  status: "active", servicer: "State Farm",        method: "autopay" },
    ...
    { id: "b9",  name: "Kitty Poo",      amount: 60.88,   dueDay: 18,   autopay: true,  status: "active", servicer: "Kitty Poo Club",    method: "autopay" },
    { id: "b10", name: "Xbox",           amount: 24.89,   dueDay: 18,   autopay: true,  status: "active", servicer: "Microsoft",         method: "autopay" },
    { id: "b11", name: "Affirm/Lauren",  amount: 58.81,   dueDay: 10,   autopay: true,  status: "active", servicer: "Shop.com/Affirm",   method: "autopay", note: "13 payments remaining — done Jun 2027" },
    { id: "b11b",name: "Affirm/Oliver", amount: null,    dueDay: null, autopay: true,  status: "active", servicer: "Shop.com/Affirm",   method: "autopay", note: "~12 payments remaining — amount TBD (confirm with Oliver)" },
    { id: "b12", name: "Electric",       amount: 321.00,  dueDay: 2,    autopay: true,  status: "active", servicer: "Entergy",           method: "autopay" },
    { id: "b13", name: "Internet",       amount: 100.00,  dueDay: 13,   autopay: true,  status: "active", servicer: "AT&T",              method: "autopay" },
    { id: "b14", name: "Car Insurance",  amount: 330.66,  dueDay: 16,   autopay: true,  status: "active", servicer: "Progressive",       method: "autopay" },
    { id: "b15", name: "Hulu",           amount: 12.00,   dueDay: 12,   autopay: true,  status: "active", servicer: "Hulu",              method: "credit card" },
    { id: "b16", name: "Dropbox",        amount: 11.99,   dueDay: 26,   autopay: true,  status: "active", servicer: "Dropbox",           method: "credit card" },
    { id: "b17", name: "Citi (debt)",    amount: 850.00,  dueDay: 18,   autopay: false, status: "active", servicer: "Citi",              method: "manual" },
    { id: "b18", name: "Craft Violins",  amount: 49.25,   dueDay: 26,   autopay: true,  status: "active", servicer: "Craft Violins LLC", method: "autopay" },
    { id: "b19", name: "YMCA",           amount: 111.00,  dueDay: 18,   autopay: true,  status: "active", servicer: "YMCA Americana",    method: "autopay" },
